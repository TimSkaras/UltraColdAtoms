...
In the last section, we considered the case where the trap frequency of the harmonic trap is suddenly changed from $\omega_0$ to 0. Now, we will consider the case where the trap frequency is changed from $\omega_0$ to a finite value $\omega_1$.
